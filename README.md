...
**DiGi.Solar** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Solar.ComputeSharp](DiGi.Solar.ComputeSharp)** (Path: `DiGi.Solar\DiGi.Solar.ComputeSharp`)
* **[DiGi.Solar](DiGi.Solar)** (Path: `DiGi.Solar\DiGi.Solar`)
