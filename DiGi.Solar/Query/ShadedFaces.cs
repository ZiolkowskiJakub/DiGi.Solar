...
namespace DiGi.Solar
{
    public static partial class Query
    {
        ...
        /// <para>If the merge fails (<c>DiGi.Geometry.Planar.Query.Union</c> returns <c>null</c> even after its snap-rounding retry), the unmerged shadows are clipped to the receiver and capped at its area instead (<see cref="ShadowFaces(PolygonalFace2D?, IEnumerable{PolygonalFace2D})"/>): a failed merge reads as shade, overstated at worst, and never as full sun.</para>
        /// </summary>
